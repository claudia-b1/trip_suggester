...
export const SUBCAT_CATEGORIES: Record<string, string> = {
  ...
  art:               "entertainment.culture.gallery,entertainment.culture.arts_centre",
  ...
  architecture:      "tourism.sights.tower,building.historic,tourism.sights.bridge,tourism.sights.city_gate,tourism.sights.windmill,tourism.sights.lighthouse,tourism.attraction.fountain",
  ...
  beaches:           "beach",
  mountains:         "natural.mountain,natural.mountain.cave_entrance,natural.mountain.volcano,natural.mountain.glacier",
  lakes_rivers:      "natural.water,natural.water.river_system,natural.water.bay",
  ...
  sport:             "sport.sports_centre,sport.stadium,sport.swimming_pool,sport.ice_rink",
  games:             "entertainment.bowling_alley,entertainment.miniature_golf,entertainment.escape_game",
