  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Route line connecting cities in order */}
        {cities.length > 1 && (
          <Source
            id="route"
            type="geojson"
        ...
        {cities.map((city) => {
          const color = MARKER_COLORS[(city.order - 1) % MARKER_COLORS.length];
        ...
        {hoveredId != null && (() => {
          ...
          return (
            <Popup
              ...
              offset={20}
            >
              <p className="text-sm font-semibold px-1">{city.name}</p>
            </Popup>
          );
        })()}
      </MapGL>
