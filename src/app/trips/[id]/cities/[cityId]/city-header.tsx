            ...
            {accom ? (
              <>
                ...
                <button
                  ...
                  className="text-xs text-[hsl(var(--primary))] hover:underline shrink-0"
                >
                  Change
                </button>
                <button
                  ...
                  className="text-xs text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] shrink-0 disabled:opacity-50"
                >
                  Unselect
                </button>
              </>
                    ...
                    {accomFavourites.map((f) => (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          {f.city && (
                            <p className="text-xs text-[hsl(var(--muted-foreground))] truncate">{f.city}</p>
                          )}
                        </div>
                        {f.list?.name && (
                          <span className="ml-auto text-xs text-[hsl(var(--muted-foreground))] shrink-0">{f.list.name}</span>
                        )}
                      </button>
                    ))}
                  </div>
